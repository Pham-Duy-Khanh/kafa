        ...
        <div class="row gutter-20">
                ...
                <div class="panel">
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            <h3 class="miniStats--title h4">Tài khoản</h3>
                            <p class="miniStats--num text-blue">{{$user_count}}</p>
                        </div>
                    </div>
                ...
                <div class="panel">
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            <h3 class="miniStats--title h4">Sản phẩm</h3>
                            <p class="miniStats--num text-orange">{{$product_count}}</p>
                        </div>
                    </div>
                    <!-- Mini Stats Panel End -->
                </div>
            ...
            <div class="col-md-3">
                <div class="panel">
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            <i class="miniStats--icon fa fa-shopping-cart text-green"></i>

                            <p class="miniStats--caption text-green">Monthly</p>
                            <h3 class="miniStats--title h4">Đơn hàng</h3>
                            <p class="miniStats--num text-green">{{$order_conut}}</p>
                        </div>
                    </div>
                    <!-- Mini Stats Panel End -->
                </div>
                ...
                <div class="panel">
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            <p class="miniStats--caption text-blue">Monthly</p>
                            <h3 class="miniStats--title h4">Tin tức</h3>
                            <p class="miniStats--num text-blue">{{$user_count}}</p>
                        </div>
                    </div>
                    <!-- Mini Stats Panel End -->
            ...
            <div class="records--list" data-title="Danh sách hóa đơn" >
                <div class="panel-body">
                    <h3 class="font-weight-bold text-blue">TÌM KIẾM ĐƠN HÀNG</h3>
                            ...
                            <table class="table style--1">
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            <div class="media--img">
                                                <img src="{{asset('public/backend/assets/img/projects/thumb-01.jpg')}}" alt="">
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            <div class="media--img">
                                                <img src="{{asset('public/backend/assets/img/projects/thumb-02.jpg')}}" alt="">
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="media">
                                            <div class="media--img">
                                                <img src="{{asset('public/backend/assets/img/projects/thumb-03.jpg')}}" alt="">
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div class="profile--panel">
                        <div class="img-wrapper" data-bg-img="assets/img/covers/01_800x150.jpg">
                            <div class="img online">
                                <img src="{{asset('public/backend/assets/img/avatars/01_150x150.png')}}" alt="" class="rounded-circle">
                            </div>
                        </div>
                ...
                <div class="panel">
                    ...
                    <div class="comments-panel">
                        <ul>
                            <li>
                                <div class="img">
                                    <img src="{{asset('public/backend/assets/img/avatars/02_40x40.png')}}" alt="" class="rounded-circle">
                                </div>
                            ...
                            <li>
                                <div class="img">
                                    <img src="{{asset('public/backend/assets/img/avatars/03_40x40.png')}}" alt="" class="rounded-circle">
                                </div>
                            ...
                            <li>
                                <div class="img">
                                    <img src="{{asset('public/backend/assets/img/avatars/04_40x40.png')}}" alt="" class="rounded-circle">
                                </div>
